...
import { ActivityIcon, Bell, Briefcase, CpuIcon, LayoutGridIcon, Lightbulb, Lock, NewspaperIcon, Plus, Smile } from 'lucide-react';
...
function SpecificSymbol({ isDark, setIsDark, isSidebarOpen, setIsSidebarOpen }) {
    ...
    return (
        <div className="h-full w-full bgcustom2">
            ...
            <div className="w-full h-[calc(100dvh-55px)] p-3 space-y-2 overflow-auto">
                {loading ? (
                    ...
                    <div className="flex flex-col h-fit min-h-full w-full px-5 py-2">
                        ...
                        <div className='flex flex-col-reverse md:flex-col'>
                            ...
                            <div className="relative border rounded-xl overflow-hidden h-[280px] mt-3">
                                ...
                                <SymbolOverview colorTheme="dark" autosize={true} symbols={[cleanSymbol]} chartOnly={"true"} scalePosition='left' />
                            </div>
                        </div>
                        ...
                        >
                            <Tabs
                                ...
                                classNames={{
                                    ...
                                    cursor: "w-full bg-[limegreen]",
                                    tab: "max-w-fit px-0 h-12",
                                    tabContent: "group-data-[selected=true]:text-[limegreen]",
                                }}
                                color="primary"
                                variant="underlined"
                            >
                                ...
                                >
                                    <div className="py-4">
                                        ...
                                        <div className="text-sm my-3 border border-gray-200 rounded-xl overflow-hidden">
                                            <CompanyProfile symbol={cleanSymbol} isTransparent="true" colorTheme="dark" height={300} width="100%" />
                                        </div>
                                    </div>
                                </Tab>
                                    ...
                                    <div className="py-4">
                                        ...
                                        <div className="text-sm my-3 flex flex-col md:flex-row gap-4">
                                            <div className="flex-1 flex-col border border-gray-200 rounded-xl overflow-hidden">
                                                <FundamentalData symbol={cleanSymbol} colorTheme="dark" height={300} width="100%" />
                                            </div>
                                            <div className="flex-1 flex-col border border-gray-200 rounded-xl overflow-hidden">
                                                <TechnicalAnalysis symbol={cleanSymbol} colorTheme="dark" height={300} width="100%" />
                                            </div>
                                        </div>
                                    </div>
                                </Tab>
                                ...
                                >
                                    <div className="py-4">
                                        ...
                                        <div className="text-sm my-3 border border-gray-200 rounded-xl overflow-hidden">
                                            <Timeline feedMode='symbol' symbol={cleanSymbol} colorTheme="dark" height={300} width="100%" />
                                        </div>
                                    </div>
                                </Tab>
