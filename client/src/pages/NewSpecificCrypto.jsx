...
import { ActivityIcon, AlertCircle, ArrowUpWideNarrow, BarChartIcon, Bell, CpuIcon, GalleryVerticalIcon, LayoutGridIcon, Lightbulb, MusicIcon, NewspaperIcon, Plus, TrendingUpIcon, Triangle, VideoIcon, X } from 'lucide-react';
import { Button, Chip, Divider, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Tab, Tabs } from '@nextui-org/react';
import { CompanyProfile, FundamentalData, MiniChart, SymbolOverview, TechnicalAnalysis, Timeline } from 'react-ts-tradingview-widgets';
import { useEffect, useRef, useState } from 'react';
import { CheckCircle, XCircle, AlertTriangle } from "lucide-react";

function NewSpecificCrypto({ isSidebarOpen, setIsSidebarOpen }) {
    ...
    return (
        <div className="h-full w-full">
            <div className="h-[calc(100dvh-50px)] w-full flex flex-col ">
                ...
                <div className="w-full h-[calc(100dvh-95px)] overflow-y-auto">
                    {loading ? (
...
export default NewSpecificCrypto;